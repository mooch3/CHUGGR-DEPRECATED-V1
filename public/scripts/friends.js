...
const usersRef = firestore.collection('testUsers').where('uid', 'not-in', [currentUser]);
const friendRef = firestore.collection('testUsers').doc(currentUser).collection('friends');
